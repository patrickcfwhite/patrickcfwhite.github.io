  ...
  const work = [
    {
      ...
      blurb: {
        ...
        process: 'For this project I recreated Tetris. I focused on the mechanics of movement and line-clearing before adding the gameplay elements of dropping, increased speed and scoring. I also created the sound effects and composed some short musical cues.',
    ...
    },
    {
      ...
      blurb: {
        task: 'For my project I did this blah blah blah',
        process: 'For my final project I decided to work alone. The app is a learning tool for guitarists. It takes a “key” input and a corresponding scale I.e. “C - Major Scale” and generates a fretboard that displays every note within the scale and can highlight positions one would play these scales in. The app also displays a score below showing one octave of the scale and will play one octave ascending and descending. Finally each fret is clickable and will play the correct pitch at that fret. The app has a React front-end and a Django backend, using PostgreSQL to store information about the scales, and also user details and saved scales. It uses two external libraries Vex Flow to generate an image of the scale and midi-sounds-react to handle the audio.',
      ...
      <div className="level">
        <div className="level-left">
            <div className="level-item">
              <div className={`project-button swiper-button-prev ${!isMobile ? 'hidden': ''}`}></div>
              <h1 className="title">~Projects</h1>
              <div className={`project-button swiper-button-next ${!isMobile ? 'hidden': ''}`}></div>
            </div>
        </div>
